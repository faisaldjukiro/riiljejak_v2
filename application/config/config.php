...
// $config['base_url'] = 'http://localhost/riiljejak';
...
$config['sess_save_path'] = APPPATH . 'cache/session/'; //ini yang kse aktif 
...
$config['rate_limit'] = [
    'time_frame' => 60, // dalam detik (1 menit)
    'max_requests' => 100 // Maksimum request per menit
];