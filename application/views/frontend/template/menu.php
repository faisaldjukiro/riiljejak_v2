<div class="back-inner-menus">
    <ul id="backmenu" class="back-menus back-sub-shadow">
        ...
        <li><a href="<?= base_url('daerah') ?>">Daerah</a>
            <ul>
                <li><a href="<?= base_url('daerah/sulawesi-utara') ?>">Sulawesi Utara</a>
                    <ul>
                        <li><a href="<?= base_url('daerah/sulawesi-utara/manado') ?>">Manado</a></li>
                        ...
                        <li><a href="<?= base_url('daerah/sulawesi-utara/kotamobagu') ?>">Kotamobagu</a></li>
                    </ul>
                </li>
        ...
        <li> <a href="<?= base_url('football') ?>">Football</a>
    ...
    <div class="searchbar-part back-search-desktop">
        ...
        <form class="search-form" method="GET" action="<?= base_url('berita/cari') ?>" id="search-form">
            <input type="text" name="keyword" class="form-input" placeholder="Cari aja!" id="keyword">
