                    ...
                    <div class="card overflow-auto">
                        <div class="card-body">
                            ...
                            <a href="<?= base_url('rj/berita/foto/tambah') ?>" type="button" title="Tambah Foto"
                                class="btn btn-primary mb-3 btn-sm"><i class="bi bi-plus-circle"></i> Iklan
                            </a>
                            <table class="table datatable table-striped nowrap" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    foreach ($iklan as $sm) : ?>
                                        <tr>
                                            <th scope="row"><?= $no++ ?></th>
                                            <td><img src="<?= base_url('img/iklan/' . $sm['foto']); ?>" alt="Gambar Berita"
                                                    style="width: 100px; height: 100px; object-fit: cover; border-radius: 8px;">
                                            </td>
                                            <td><?= $sm['nama']; ?></td>
                                            <td><?= $sm['judul_iklan']; ?></td>
                                            <td><?= tanggal_indo($sm['tanggal_mulai']); ?></td>
                                            <td><?= tanggal_indo($sm['tanggal_berakhir']); ?></td>
                                            <td>
                                                <?php
                                                if ($sm['status_iklan'] == 'ya') {
                                                    echo '<span class="badge bg-success">Tayang</span>';
                                                } else if ($sm['status_iklan'] == 'no') {
                                            ...
                                            <td>
                                                <a type="button"
                                                    href="<?= base_url('rj/berita/foto/detail/') . $sm['id_iklan']; ?>"
                                                    class="badge bg-success"><i class="bi bi-eye"></i></a>

                                                <a type="button"
                                                    href="<?= base_url('rj/berita/foto/edit/') . $sm['id_iklan']; ?>"
                                                    class="badge bg-info"><i class="bi bi-pencil"></i></a>

                                                <a type="button" class="hapus badge bg-danger"
                                                    href="<?= base_url('rj/berita/foto/hapus/') . $sm['id_iklan']; ?>"><i
                                                        class="bi bi-trash"></i></a>

                                                <!-- <a type="button"
                                                href="<?= base_url('transaksi/obat-masuk-edit/') . $sm['id_iklan']; ?>"
