...
<title><?= $title ?> | RIIL JEJAK </title>
<meta content="" name="description">
<meta content="" name="keywords">

<!-- Favicons -->
<!-- <link href="<?php echo base_url('template') ?>/assets/img/favicon.png" rel="icon"> -->
<link rel="icon" type="image/png" href="<?= base_url('template/frontend/assets/') ?>assets/images/fav.png" />
...
<link href="<?php echo base_url('template') ?>/assets/vendor/quill/quill.snow.css" rel="stylesheet">
<link href="<?php echo base_url('template') ?>/assets/vendor/quill/quill.bubble.css" rel="stylesheet">
<link href="<?php echo base_url('template') ?>/assets/vendor/remixicon/remixicon.css" rel="stylesheet">
<link href="<?php echo base_url('template') ?>/assets/vendor/simple-datatables/style.css" rel="stylesheet">
