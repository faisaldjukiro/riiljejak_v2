...
<body>
    ...
    <main id="main" class="main">
        ...
        <section class="section">
                            ...
                            <table class="table datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $sm['urutan']; ?></td>
                                        <td>
                                            <a class="badge bg-primary" data-bs-target="#editMenuModal<?= $sm['id']; ?>"
                                                data-bs-toggle="modal"><i class="bi bi-pencil"></i></a>

                                            <a href="" class="badge bg-danger" data-bs-target="#hapus<?= $sm['id']; ?>"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="<?= base_url('rj/settings/submenu') ?>" method="post">
            ...
            <div class="modal fade" id="editMenuModal<?= $sm['id']; ?>" tabindex="-1"
                        ...
                        <div class="modal-body">
                            <form action="<?= base_url('rj/settings/editsubmenu') ?>" method="post">
                                ...
                                <div class="form-group  mr-1">
                                    ...
                                    <input type="number" class="form-control border" name="urutan" id="urutan"
                                        value="<?php echo $sm['urutan']; ?>" required>
                                </div>
            ...
            <?php $no = 0;
            foreach ($subMenu as $sm) : $no++; ?>
            <div class="modal fade" id="hapus<?= $sm['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <form class="form-horizontal" method="post"
                                action="<?php echo base_url('rj/settings/hapussubmenu') ?>">
                                <div class="modal-body">
